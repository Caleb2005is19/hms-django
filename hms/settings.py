...
SECRET_KEY = config("SECRET_KEY") 'django-insecure-^0dk(g@g3dh@(suw6+l#sg#&2#s%!sc^o6jmc5ic+tt-=^ati_'
...
LOGIN_REDIRECT_URL = 'dashboard' # Go here after logging in
LOGOUT_REDIRECT_URL = 'login'    # Go here after logging out